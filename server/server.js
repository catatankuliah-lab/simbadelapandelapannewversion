...
const desa2410Routes = require('./routes/desa2410Routes');
const desa2412Routes = require('./routes/desa2412Routes');
...
const wo2410Routes = require('./routes/wo2410Routes');
const wo2412Routes = require('./routes/wo2412Routes');
...
const itemWo2410Routes = require('./routes/itemWo2410Routes');
const itemWo2412Routes = require('./routes/itemWo2412Routes');
...
app.use('/api/desa2410', desa2410Routes);
app.use('/api/desa2412', desa2412Routes);
...
app.use('/api/wo2410', wo2410Routes);
app.use('/api/wo2412', wo2412Routes);
app.use('/api/lo', loRoutes);
app.use('/api/do', doRoutes);
app.use('/api/sjt', sjtRoutes);
app.use('/api/itemwo2408', itemWo2408Routes);
app.use('/api/itemwo2410', itemWo2410Routes);
app.use('/api/itemwo2412', itemWo2412Routes);
