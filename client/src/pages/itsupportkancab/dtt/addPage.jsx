...
const AddPage = ({ handlePageChange }) => {
    ...
    const handleClick = (iddesa) => {
        setDetailId(iddesa);
    };

    useEffect(() => {
        if (detailId !== '') {
            handlePageChange('detailkpm', detailId);
        }
    ...
    return (
        <div className="row">
            ...
            <div className="col-md-12 mt-3">
                <form id="form">
                    <div className="row">
                        <div className="col-md-6 col-sm-12 mb-3 d-none">
                        ...
                        <tbody>
                            {desaOption.map((desa, index) => (
                                <tr key={desa.id_desa_kelurahan}>
                                    ...
                                    <td style={{ width: "5px" }}>
                                        <button className="btn btn-link p-0" onClick={() => handleClick(desa.id_desa_kelurahan)}>
