...
const Desa2408 = sequelize.define(
  ...
  },
  {
    ...
    hooks: {
      beforeCreate: (desa_kelurahan_2408) => {
        desa_kelurahan_2408.kode_desa_kelurahan = desa_kelurahan_2408.kode_desa_kelurahan.toUpperCase();
        desa_kelurahan_2408.nama_desa_kelurahan = desa_kelurahan_2408.nama_desa_kelurahan.toUpperCase();
      },
      beforeUpdate: (desa_kelurahan_2408) => {
        desa_kelurahan_2408.kode_desa_kelurahan = desa_kelurahan_2408.kode_desa_kelurahan.toUpperCase();
        desa_kelurahan_2408.nama_desa_kelurahan = desa_kelurahan_2408.nama_desa_kelurahan.toUpperCase();
      },
    },
